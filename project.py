...
# Importing login_required from login.py
...
def gconnect():
    ...
    if request.args.get('state') != login_session['state']:
        ...
        return response
    # Obtaining authorization code, now compatible with Python3
    ...
    # Checking if user exists. If it doesn't make a new one.
    ...
    flash("Hurray!You are now logged in as %s" % login_session['username'])
    return output
